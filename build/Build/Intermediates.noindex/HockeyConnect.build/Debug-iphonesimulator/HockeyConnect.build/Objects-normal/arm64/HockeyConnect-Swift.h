...
#ifndef HOCKEYCONNECT_SWIFT_H
#define HOCKEYCONNECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HockeyConnect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSURL;
@class NSData;
SWIFT_CLASS("_TtC13HockeyConnect11AppDelegate")
...
- (void)application:(UIApplication * _Nonnull)application didReceiveRemoteNotification:(NSDictionary * _Nonnull)notification fetchCompletionHandler:(void (^ _Nonnull)(UIBackgroundFetchResult))completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class FIRMessaging;
@class NSString;
@interface AppDelegate (SWIFT_EXTENSION(HockeyConnect)) <FIRMessagingDelegate>
- (void)messaging:(FIRMessaging * _Nonnull)messaging didReceiveRegistrationToken:(NSString * _Nullable)fcmToken;
@end

@class UNUserNotificationCenter;
@class UNNotification;
@interface AppDelegate (SWIFT_EXTENSION(HockeyConnect)) <UNUserNotificationCenterDelegate>
